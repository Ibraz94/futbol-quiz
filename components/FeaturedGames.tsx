      ...
      <div className='flex items-center justify-between'>
        ...
        <Swiper
          ...
          {featuredGames.map((game, index) => (
            <SwiperSlide>
              <div className='w-[410px] h-[410px] rounded-[20px] flex justify-center items-center bg-pink-50/20 object-fill'>
                <Image src={game.image} alt="game" width={400} height={400} />
              </div>
            </SwiperSlide>
          ))}
